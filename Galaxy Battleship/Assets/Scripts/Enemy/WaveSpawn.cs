...
public class WaveSpawn : MonoBehaviour
{
    ...
    public TMP_Text TextTimeNextWaveTXT;
    ...
    [SerializeField]
    private float searchCoutdown = 2f;
    ...
    void Update()
    {
        ...
        TextTimeNextWave.text = waveCountdown.ToString("f0");
    ...
    IEnumerator SpawnWave(Wave waves)
    {
        ...
        TextTimeNextWaveTXT.gameObject.SetActive(false);
    ...
    void TimeTextWave()
    {
        ...
        TextTimeNextWaveTXT.gameObject.SetActive(true);
    }
